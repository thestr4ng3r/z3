...
extern "C" {
    ...
    */
    Z3_ast Z3_API Z3_mk_interpolant(__z3_in Z3_context c, __z3_in Z3_ast a);
    ...
    */
    ...
    Z3_context Z3_API Z3_mk_interpolation_context(__z3_in Z3_config cfg);
    ...
    Z3_lbool Z3_API Z3_compute_interpolant(__z3_in Z3_context c, 
                                           __z3_in Z3_ast pat, 
                                           __z3_in Z3_params p, 
                                           __z3_out Z3_ast_vector *interp, 
    ...
    Z3_string Z3_API Z3_interpolation_profile(__z3_in Z3_context ctx);
    ...
    int Z3_API Z3_read_interpolation_problem(__z3_in Z3_context ctx,
                                             __z3_out unsigned *num,
                                             __z3_out Z3_ast *cnsts[],
                                             __z3_out unsigned *parents[],
                                             __z3_in Z3_string filename,
                                             __out_opt Z3_string_ptr error,
                                             __z3_out unsigned *num_theory,
                                             __z3_out Z3_ast *theory[]);
    ...
    int Z3_API Z3_check_interpolant(__z3_in Z3_context ctx,
    ...
    void Z3_API  Z3_write_interpolation_problem(__z3_in Z3_context ctx,
                                                __z3_in unsigned num,
                                                __in_ecount(num) Z3_ast cnsts[],
                                                __in_ecount(num) unsigned parents[],
                                                __z3_in Z3_string filename,
