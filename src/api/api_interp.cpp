...
extern "C" {
    ...
    Z3_ast_vector Z3_API Z3_get_interpolant(__z3_in Z3_context c, __z3_in Z3_ast pf, __z3_in Z3_ast pat, __z3_in Z3_params p){
        Z3_TRY;
    ...
    Z3_lbool Z3_API Z3_compute_interpolant(__z3_in Z3_context c, __z3_in Z3_ast pat, __z3_in Z3_params p, __z3_out Z3_ast_vector *out_interp, __z3_out Z3_model *model){
        Z3_TRY;
...
Z3_lbool Z3_API Z3_interpolate(__z3_in Z3_context ctx,
                               __z3_in unsigned num,
                               __in_ecount(num) Z3_ast *cnsts,
                               __in_ecount(num) unsigned *parents,
                               __z3_in Z3_params options,
                               __out_ecount(num - 1) Z3_ast *interps,
                               __z3_out Z3_model *model,
                               __z3_out Z3_literals *labels,
                               __z3_in unsigned incremental,
                               __z3_in unsigned num_theory,
